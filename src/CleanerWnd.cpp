...
int CCleanerWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CCleanerWnd::OnDestroy()
{
    UnInitKClear();
    PostQuitMessage(0);
}

void CCleanerWnd::OnClose()
{
    DestroyWindow();
}

void CCleanerWnd::OnPaint(CDCHandle dc)
{

}

BOOL CCleanerWnd::OnEraseBkgnd(CDCHandle dc)
{
    return TRUE;
}

void CCleanerWnd::OnSize(UINT nType, CSize size)
{
